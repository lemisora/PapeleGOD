        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="perfil.php"><i class="fas fa-user"></i> Ver Perfil</a></li>
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <a href="actualizar.php" class="btn btn-success btn-custom mx-2">Actualizar Datos</a>
